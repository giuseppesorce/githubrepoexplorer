...
@Suppress("UNCHECKED_CAST")
private fun <T, V : View> required(finder: T.(Int) -> View?, contextFinder: T.() -> Context): ReadOnlyProperty<T, V>
        = Lazy { t: T, desc: KProperty<*> -> findWithNoId<T, V>(t, desc, finder, contextFinder) ?: viewNotFound(0, desc)
}

@Suppress("UNCHECKED_CAST")
fun <T, V> findWithNoId(t: T, desc: KProperty<*>, finder: T.(Int) -> View?, contextFinder: T.() -> Context): V? {
