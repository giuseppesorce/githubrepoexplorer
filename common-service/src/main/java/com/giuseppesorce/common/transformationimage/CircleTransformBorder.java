package com.giuseppesorce.common.transformationimage;
...
public class CircleTransformBorder implements Transformation {
    private int BORDER_COLOR = Color.GRAY;
    private final int BORDER_RADIUS = 5;

   public  CircleTransformBorder(){

   }
   public  CircleTransformBorder(int color){
       BORDER_COLOR= color;
   }
    @Override
